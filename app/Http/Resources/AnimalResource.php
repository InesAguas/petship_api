...
class AnimalResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'raca' => DB::table('traducoes')->where('id', $this->raca)->where('tipo', $this->especie == 1 ? 'raca_caes':'raca_gatos')->first()->pt,
    ...
    public function toArrayEnglish()
    {
        return [
            ...
            'raca' => DB::table('traducoes')->where('id', $this->raca)->where('tipo', $this->especie == 1 ? 'raca_caes':'raca_gatos')->first()->en,
